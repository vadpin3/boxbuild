    ...
    <div class="container container--with-sidebar">
      ...
      <div class="content">
        ...
        <main class="content__main">
          <?php
            $con = mysqli_connect("localhost", "root", "root", "lesson8");
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
              $form = $_POST;
              $errors = [];
              $req_field = ['email', 'password', 'name'];
              ...
              if (empty($errors)) {
                ...
                if (mysqli_num_rows($res) > 0) {
                  $errors[] = 'Пользователь с этим email уже существует';
                }
                else {
          ...
          <form class="form" action="" method="post" autocomplete="off">
            ...
            <div class="form__row">
              ...
              <input class="form__input" type="text" name="email" id="email" value="<?=$values['email'] ?? ''; ?>" placeholder="Введите e-mail">
            ...
            <div class="form__row">
              ...
              <input class="form__input" type="text" name="name" id="name" value="<?=$values['name'] ?? ''; ?>" placeholder="Введите пароль">
            </div>

            <div class="form__row">
              <p class="error-message">Пожалуйста, исправьте ошибки в форме</p>

              <input class="button form_control" type="submit" name="" value="Зарегистрироваться">
            </div>
          </form>
        </main>
      </div>
