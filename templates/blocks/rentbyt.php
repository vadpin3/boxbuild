    ...
    echo '
      <div class="preview_bytovka-item">
        <div class="preview_bytovka-main">
          ...
          <div class="preview_bytovka-content"><a class="preview_bytovka-heading" href="#"> '.$value['title'].'</a>
            <div class="preview_bytovka-gabarits"> '.$value['size'].'</div>
            ...
            <div>Доступно для заказа в &lt; городе&gt;</div>
            <div class="preview_bytovka-order">
              <div class="preview_bytovka-price">Цена: <span> '.$value['price'].'</span></div>
